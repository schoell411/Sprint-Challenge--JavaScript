...
let unisWithUni = [];
// unisWithUni = graduates.filter(function (school){
//   school.university.includes('Uni'))
...
lowCaseAnimalNames = zooAnimals.map(element =>
...
lowPopulationAnimals = zooAnimals.filter(low_pop => low_pop.population < 5)
...
populationTotal = zooAnimals.reduce((pop, zoo) => pop + zoo.population, 0)
